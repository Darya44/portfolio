  ...
  const renderLootboxesLeft = () => (
    <div className="space-y-5 font-sans text-white/85 [&>p]:max-w-[380px] [&>p]:text-white/70">
      ...
      <p>
        ...
        свечение, градиенты и контрастные цвета. В результате получилась масштабируемая визуальная система, которая поддерживает
        геймификацию продукта, сохраняет единый стиль и легко адаптируется под разные типы лутбоксов и кампаний.
      </p>
    </div>
  );
  ...
  const renderWallpapersLeft = () => (
    <div className="space-y-5 font-sans text-white/85 [&>p]:max-w-[380px] [&>p]:text-white/70">
      ...
      <p>
        ...
        амбассадорам бренда. Важно было сохранить единый визуальный язык бренда и при этом адаптировать стиль под разные
        сценарии коммуникации — атмосферный сезонный и более айдентичный, связанный с командами и спортивной символикой.
      </p>
      <p>
        В процессе работы я прорабатывала композицию, освещение и цветовые акценты, интегрируя фирменные элементы Winline в
        сюжетные сцены и интерфейсный формат iOS-заставок. В новогодней серии акцент был сделан на ощущении праздника через
        окружение, свет и детали, а в серии с командами — на узнаваемости бренда через цвета, символику и визуальные ассоциации
        с амбассадорами. В результате получились две визуально связанные серии, которые усиливают присутствие бренда в интерфейсе
