...
export const projects = [
{
  ...
  },
  {
    ...
    shortDescription: `В агенстве мне удалось поучаствовать в тендерах на креативную поддержку. Расскажу про некоторые кейсы от идей до их воплощения. Бренды с которыми я поработала: Лемана ПРО, Барьер, Купер.
